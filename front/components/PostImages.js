...
const PostImages = ({ images }) => {
    ...
    if (images.length === 1) {
        return (
            <>
                <img role="presentation" style={{ display: 'inline-block', maxWidth: '100%', maxHeight: '400px', width: 'auto' }} src={`http://localhost:3065/${images[0].src}`} alt={images[0].src} onClick={onZoom} />
